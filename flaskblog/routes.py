...
posts = [
		{
			...
			'date_posted':'22nd May, 2020'
		},
		{
			'author': 'Shubham Roy Chowdhuary',
			'title':'Blog Post 2',
			'content':'second Post Content',
			'date_posted':'11th May, 2020'
		},
		{
			'author': 'Arindam Ghosh',
			'title':'Blog Post 3',
			'content':'third Post Content',
			'date_posted':'5th May, 2020'
		},
	]
...
@app.route('/about')
def about():
	return render_template('about.html',title='Adhiraj')
...
def account():
	...
	if form.validate_on_submit():
		if form.picture.data:
			profile_pics= save_picture(form.picture.data)
			current_user.image_file = profile_pics
...
def delete_post(post_id):
	...
	db.session.commit()
	flash('Your post have been deleted successfully !','success')
	return redirect(url_for('home'))
